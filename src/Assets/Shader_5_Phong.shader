    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 view_directioin = normalize(TransformViewToWorld(float3(0,0,0)) - IN.position);
                ...
                half3 specular = _SpecularIntensity * pow(max(0, dot(reflected_direction, view_directioin)), _SpecularPower);
